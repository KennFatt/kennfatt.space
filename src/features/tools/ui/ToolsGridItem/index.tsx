...
export const ToolsGridItem: FC<ToolsGridItemProps> = ({
  ...
  return (
    <a
      href={href}
      className="group transition-colors rounded-lg p-2 border-2 bg-base-light-dim dark:bg-base-dark-dim dark:border-base-dark-dim border-base-light-dim space-y-4"
    >
      {/* Title */}
